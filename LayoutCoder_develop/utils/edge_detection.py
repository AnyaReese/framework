...
def fined_edge_detection(image, kernel_type="extend"):
    ...
    # 原作者未提供，以下是根据猜测还原的代码
    # from edge.utils.ndarray_operator import ndarray_add_num, ndarray_add_arr

    def ndarray_add_num(arr, value, threshold=0):
        # 给数组整体加一个数，并裁剪在[0,255]之间
        result = arr + value
        result[result < threshold] = 0  # 小于阈值的置零
